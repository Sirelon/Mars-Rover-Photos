...
dependencies {
    ...
    // Installs the Baseline Profile on sideloaded builds and lets Macrobenchmark compile against it.
    implementation(libs.androidx.profileinstaller)
    // Generated by :baselineprofile into src/release/generated/baselineProfiles/.
